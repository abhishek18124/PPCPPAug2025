...
void f(char inp[], int i) {
	...
	// f(i) = it is a fn that replaces all the "pi" with "3.14" in the inp[i...n-1]

	if (inp[i] == 'p' and inp[i + 1] == 'i') {

		// replace "pi" at the (i, i+1)th index with "3.14"

		// starting from index i+2, shift all the characters 2-steps to right
